<template>
  <div class="side-menu-wrapper">
    <slot></slot>
    <Menu ref="menu" style="z-index:0;" v-show="!collapsed" :active-name="activeName" :open-names="openedNames" :accordion="accordion" :theme="theme" width="auto" @on-select="handleSelect">
